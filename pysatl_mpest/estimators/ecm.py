...
implementation of the :class:`~pysatl_mpest.estimators.base_estimator.BaseEstimator`.
It uses a pipeline architecture (:class:`~pysatl_mpest.estimators.iterative.pipeline.Pipeline`)
