...
from rework_pysatl_mpest.initializers.clusterize.utils import (
...
class TestUtils:
    ...
    def test_precompute_fits(self):
        ...
        with patch("rework_pysatl_mpest.initializers.clusterize.utils._estimate_and_score_component") as mock_est:
