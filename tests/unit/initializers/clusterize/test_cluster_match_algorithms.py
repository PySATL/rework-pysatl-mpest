...
from pysatl_mpest.initializers import ClusterizeInitializer, MatchingMethod, ScoringMethod
from pysatl_mpest.initializers.clusterize._cluster_match_algorithms import (
    _match_greedy,
    _match_hungarian,
    _match_permutations,
)
...
class TestClusterMatchAlgorithms:
    ...
    def test_match_greedy(self, strategy_context):
        ...
        with patch(
            "pysatl_mpest.initializers.clusterize._cluster_match_algorithms._estimate_and_score_component"
        ) as mock_est:
    ...
    def test_match_hungarian(self, strategy_context):
        ...
        with patch(
            "pysatl_mpest.initializers.clusterize._cluster_match_algorithms._precompute_fits"
        ) as mock_precompute:
