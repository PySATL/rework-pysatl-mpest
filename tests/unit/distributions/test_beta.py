...
class TestBetaInitialization:
    ...
    def test_repr_method(self):
        ...
        dist = Beta(alpha=1.1, beta=2.1, left_border=10.1, right_border=20.1)
        repr_str = repr(dist)
        assert (
            repr_str == f"Beta(alpha={dist.alpha}, beta={dist.beta}, left_border={dist.left_border}, "
            f"right_border={dist.right_border})"
        )
...
class TestBetaLPDF:
    ...
    def test_lpdf_return_type_and_shape_for_array_input(self, params, x):
    ...
    def test_lpdf_return_type_and_shape_for_scalar_input(self, params, x):
...
class TestBetaPPF:
    ...
    def test_ppf_return_type_and_shape_for_array_input(self, params, p):
    ...
    def test_ppf_return_type_and_shape_for_scalar_input(self, params, p):
...
class TestBetaGradients:
    ...
    def test_dlog_shape1_numerical_for_array_input(self, params_x):
    ...
    def test_dlog_shape1_for_scalar_input(self, params_x):
    ...
    @given(params_x=st_params_and_array_x_for_grad())
    def test_dlog_shape2_numerical_for_array_input(self, params_x):
    ...
    @given(params_x=st_params_and_scalar_x_for_grad())
    def test_dlog_shape2_for_scalar_input(self, params_x):
    ...
    @given(params_x=st_params_and_array_x_for_grad())
    def test_dlog_left_border_numerical_for_array_input(self, params_x):
    ...
    @given(params_x=st_params_and_scalar_x_for_grad())
    def test_dlog_left_border_for_scalar_input(self, params_x):
    ...
    @given(params_x=st_params_and_array_x_for_grad())
    def test_dlog_right_border_numerical_for_array_input(self, params_x):
    ...
    @given(params_x=st_params_and_scalar_x_for_grad())
    def test_dlog_right_border_for_scalar_input(self, params_x):
    ...
    @given(params_x=st_params_and_scalar_x_for_grad())
    def test_log_gradients_for_scalar_input(self, params_x):
