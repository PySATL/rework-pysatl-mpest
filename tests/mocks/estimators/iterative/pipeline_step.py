...
class MockCallbackPipelineStep(PipelineStep):
    ...
    run_callback : Callable[[PipelineState], PipelineState], optional
    ...
    def __init__(
        self,
        available_steps: list[type[PipelineStep]],
        run_callback: Callable[[PipelineState], PipelineState] | None = None,
    ) -> None:
